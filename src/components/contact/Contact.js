...
const Contact = () => {
    ...
    const handleSend = (e) => {
        ...
        if (username === '') {
            ...
            const mailtoLink = `mailto:christyvinoy2003@gmail.com=${encodeURIComponent(
                subject
            )}&body=${encodeURIComponent(
                `Name: ${username}%0D%0APhone Number: ${phoneNumber}%0D%0AEmail: ${email}%0D%0AMessage: ${message}`
            )}`;
    ...
    return (
        <section id="contact" className="w-full py-20 border-b-[1px] border-b-black px-8">
            ...
            <div className="w-full flex">
                <div className="w-full h-auto flex justify-between">
                    <ContactLeft />
                    <div className="w-[60%] h-auto bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg shadow-shadowOne flex flex-col gap-8">
