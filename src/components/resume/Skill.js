          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                className="w-[25%] h-full bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 rounded-md relative"
              >
                <span className="absolute -top-7 right-0">25%</span>
              </motion.span>
            </span>
          </div>
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[80%] h-full bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[50%] h-full bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[65%] h-full bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[90%] h-full bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 rounded-md relative"
              >
